...
void Shr3::estimate(const Parameters &params, Indicators &indicators) const {
...
std::shared_ptr<MetaElement> Shr3::create(const NodeType &nodetype,
  ...
  return std::make_shared<Shr3>(lowerCaseName, "std", true, params, ports);
}

std::unique_ptr<Element> Shr3::construct() const {
