...
DE10_LINUX=$UTOPIA_HOME/target/de10standard/linux/cma/
...
CFLAGS="$DEFINES -fpermissive -I. -I$UTOPIA_HOME/src -I$DE10_DRIVER -I$DE10_LINUX/include -I$DE10_LINUX/driver"
g++ $CFLAGS runtime.cc device_api.cc $DE10_LINUX/api/src/cma_api.c $DE10_DRIVER/de10nano_driver.cc
