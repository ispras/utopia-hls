...
firrtl.circuit "ScalarMul" {
    ...
    %delay_fixed_16_0_1_34_12_clock, %delay_fixed_16_0_1_34_12_reset, %delay_fixed_16_0_1_34_12_in,  %delay_fixed_16_0_1_34_12_out = firrtl.instance delay_fixed_16_0_1_34_12 @delay_fixed_16_0_1_34(in clock : !firrtl.clock, in reset : !firrtl.reset, in in : !firrtl.sint<16>, out out : !firrtl.sint<16> )
    %delay_fixed_16_0_1_25_13_clock, %delay_fixed_16_0_1_25_13_reset, %delay_fixed_16_0_1_25_13_in,  %delay_fixed_16_0_1_25_13_out = firrtl.instance delay_fixed_16_0_1_25_13 @delay_fixed_16_0_1_25(in clock : !firrtl.clock, in reset : !firrtl.reset, in in : !firrtl.sint<16>, out out : !firrtl.sint<16> )
    %delay_fixed_16_0_1_11_14_clock, %delay_fixed_16_0_1_11_14_reset, %delay_fixed_16_0_1_11_14_in,  %delay_fixed_16_0_1_11_14_out = firrtl.instance delay_fixed_16_0_1_11_14 @delay_fixed_16_0_1_11(in clock : !firrtl.clock, in reset : !firrtl.reset, in in : !firrtl.sint<16>, out out : !firrtl.sint<16> )
    ...
    %delay_fixed_16_0_1_34_16_clock, %delay_fixed_16_0_1_34_16_reset, %delay_fixed_16_0_1_34_16_in,  %delay_fixed_16_0_1_34_16_out = firrtl.instance delay_fixed_16_0_1_34_16 @delay_fixed_16_0_1_34(in clock : !firrtl.clock, in reset : !firrtl.reset, in in : !firrtl.sint<16>, out out : !firrtl.sint<16> )
    
    // Connections
    firrtl.connect %MUL2166_clock, %clock : !firrtl.clock, !firrtl.clock
    firrtl.connect %MUL2166_reset, %reset : !firrtl.reset, !firrtl.reset
    firrtl.connect %MUL2166__dfc_wire_4855, %source__dfc_wire_4855__dfc_wire_4853 : !firrtl.sint<16>, !firrtl.sint<16>
    firrtl.connect %delay_fixed_16_0_1_11_14_in, %MUL2166__dfc_wire_4859 : !firrtl.sint<16>, !firrtl.sint<16>
    ...
    firrtl.connect %ADD2168__dfc_wire_4863, %MUL2167__dfc_wire_4859 : !firrtl.sint<16>, !firrtl.sint<16>
    ...
    firrtl.connect %delay_fixed_16_0_1_34_12_in, %MUL2169__dfc_wire_4859 : !firrtl.sint<16>, !firrtl.sint<16>
    ...
    firrtl.connect %delay_fixed_16_0_1_34_12_clock, %clock : !firrtl.clock, !firrtl.clock
    firrtl.connect %delay_fixed_16_0_1_34_12_reset, %reset : !firrtl.reset, !firrtl.reset
    firrtl.connect %ADD2170__dfc_wire_4863, %delay_fixed_16_0_1_34_12_out : !firrtl.sint<16>, !firrtl.sint<16>
    firrtl.connect %delay_fixed_16_0_1_25_13_clock, %clock : !firrtl.clock, !firrtl.clock
    firrtl.connect %delay_fixed_16_0_1_25_13_reset, %reset : !firrtl.reset, !firrtl.reset
    firrtl.connect %delay_fixed_16_0_1_25_13_in, %source__dfc_wire_4854__dfc_wire_4853 : !firrtl.sint<16>, !firrtl.sint<16>
    firrtl.connect %MUL2169__dfc_wire_4852, %delay_fixed_16_0_1_25_13_out : !firrtl.sint<16>, !firrtl.sint<16>
    firrtl.connect %delay_fixed_16_0_1_11_14_clock, %clock : !firrtl.clock, !firrtl.clock
    firrtl.connect %delay_fixed_16_0_1_11_14_reset, %reset : !firrtl.reset, !firrtl.reset
    firrtl.connect %ADD2168__dfc_wire_4859, %delay_fixed_16_0_1_11_14_out : !firrtl.sint<16>, !firrtl.sint<16>
    ...
    firrtl.connect %delay_fixed_16_0_1_34_16_clock, %clock : !firrtl.clock, !firrtl.clock
    firrtl.connect %delay_fixed_16_0_1_34_16_reset, %reset : !firrtl.reset, !firrtl.reset
    firrtl.connect %delay_fixed_16_0_1_34_16_in, %source__dfc_wire_4852__dfc_wire_4853 : !firrtl.sint<16>, !firrtl.sint<16>
    firrtl.connect %MUL2166__dfc_wire_4852, %delay_fixed_16_0_1_34_16_out : !firrtl.sint<16>, !firrtl.sint<16>
    ...
    firrtl.extmodule @delay_fixed_16_0_1_11(
        in clock : !firrtl.clock,
        in reset : !firrtl.reset,
    ...
    firrtl.extmodule @delay_fixed_16_0_1_25(
        in clock : !firrtl.clock,
        in reset : !firrtl.reset,
        in in : !firrtl.sint<16>,
    ...
    firrtl.extmodule @delay_fixed_16_0_1_34(
        in clock : !firrtl.clock,
        in reset : !firrtl.reset,
        in in : !firrtl.sint<16>,
