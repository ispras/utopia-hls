...
firrtl.circuit "VectorSum" {
    ...
    %delay_fixed_16_0_1_49_16_clock, %delay_fixed_16_0_1_49_16_reset, %delay_fixed_16_0_1_49_16_in,  %delay_fixed_16_0_1_49_16_out = firrtl.instance delay_fixed_16_0_1_49_16 @delay_fixed_16_0_1_49(in clock : !firrtl.clock, in reset : !firrtl.reset, in in : !firrtl.sint<16>, out out : !firrtl.sint<16> )
    %delay_fixed_16_0_1_39_17_clock, %delay_fixed_16_0_1_39_17_reset, %delay_fixed_16_0_1_39_17_in,  %delay_fixed_16_0_1_39_17_out = firrtl.instance delay_fixed_16_0_1_39_17 @delay_fixed_16_0_1_39(in clock : !firrtl.clock, in reset : !firrtl.reset, in in : !firrtl.sint<16>, out out : !firrtl.sint<16> )
    %delay_fixed_16_0_1_2_18_clock, %delay_fixed_16_0_1_2_18_reset, %delay_fixed_16_0_1_2_18_in,  %delay_fixed_16_0_1_2_18_out = firrtl.instance delay_fixed_16_0_1_2_18 @delay_fixed_16_0_1_2(in clock : !firrtl.clock, in reset : !firrtl.reset, in in : !firrtl.sint<16>, out out : !firrtl.sint<16> )
    %delay_fixed_16_0_1_21_19_clock, %delay_fixed_16_0_1_21_19_reset, %delay_fixed_16_0_1_21_19_in,  %delay_fixed_16_0_1_21_19_out = firrtl.instance delay_fixed_16_0_1_21_19 @delay_fixed_16_0_1_21(in clock : !firrtl.clock, in reset : !firrtl.reset, in in : !firrtl.sint<16>, out out : !firrtl.sint<16> )
    ...
    firrtl.connect %delay_fixed_16_0_1_49_16_clock, %clock : !firrtl.clock, !firrtl.clock
    firrtl.connect %delay_fixed_16_0_1_49_16_reset, %reset : !firrtl.reset, !firrtl.reset
    firrtl.connect %delay_fixed_16_0_1_49_16_in, %source__dfc_wire_4831__dfc_wire_4825 : !firrtl.sint<16>, !firrtl.sint<16>
    firrtl.connect %ADD2153__dfc_wire_4828, %delay_fixed_16_0_1_49_16_out : !firrtl.sint<16>, !firrtl.sint<16>
    firrtl.connect %delay_fixed_16_0_1_39_17_clock, %clock : !firrtl.clock, !firrtl.clock
    firrtl.connect %delay_fixed_16_0_1_39_17_reset, %reset : !firrtl.reset, !firrtl.reset
    firrtl.connect %delay_fixed_16_0_1_39_17_in, %source__dfc_wire_4826__dfc_wire_4825 : !firrtl.sint<16>, !firrtl.sint<16>
    firrtl.connect %ADD2152__dfc_wire_4824, %delay_fixed_16_0_1_39_17_out : !firrtl.sint<16>, !firrtl.sint<16>
    firrtl.connect %delay_fixed_16_0_1_2_18_clock, %clock : !firrtl.clock, !firrtl.clock
    firrtl.connect %delay_fixed_16_0_1_2_18_reset, %reset : !firrtl.reset, !firrtl.reset
    firrtl.connect %delay_fixed_16_0_1_2_18_in, %source__dfc_wire_4825__dfc_wire_4825 : !firrtl.sint<16>, !firrtl.sint<16>
    firrtl.connect %ADD2151__dfc_wire_4824, %delay_fixed_16_0_1_2_18_out : !firrtl.sint<16>, !firrtl.sint<16>
    firrtl.connect %delay_fixed_16_0_1_21_19_clock, %clock : !firrtl.clock, !firrtl.clock
    firrtl.connect %delay_fixed_16_0_1_21_19_reset, %reset : !firrtl.reset, !firrtl.reset
    firrtl.connect %delay_fixed_16_0_1_21_19_in, %source__dfc_wire_4824__dfc_wire_4825 : !firrtl.sint<16>, !firrtl.sint<16>
    firrtl.connect %ADD2150__dfc_wire_4824, %delay_fixed_16_0_1_21_19_out : !firrtl.sint<16>, !firrtl.sint<16>
    ...
    firrtl.extmodule @delay_fixed_16_0_1_2(
        in clock : !firrtl.clock,
        in reset : !firrtl.reset,
    ...
    firrtl.extmodule @delay_fixed_16_0_1_39(
        in clock : !firrtl.clock,
        in reset : !firrtl.reset,
        in in : !firrtl.sint<16>,
    ...
    firrtl.extmodule @delay_fixed_16_0_1_49(
        in clock : !firrtl.clock,
        in reset : !firrtl.reset,
        in in : !firrtl.sint<16>,
